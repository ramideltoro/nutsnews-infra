...
- `caddy/Caddyfile`: Caddy config with admin API disabled, public TLS for `vps.nutsnews.com` and `ops.nutsnews.com`, plus loopback portal access for health checks and SSH tunnel fallback.
