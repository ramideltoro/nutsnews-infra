...
for required in (
    ...
    'gh pr view "$PR_URL" --json mergeStateStatus,headRefOid,number,state',
    '"repos/${GITHUB_REPOSITORY}/pulls/${pr_number}/update-branch"',
    '-f expected_head_sha="$pr_head_sha"',
    "Release promotion PR is behind main; updating it and rerunning checks.",
    "Main advanced during the release merge; retrying from the new base.",
    '[[ "$merge_state" == "DIRTY" ]]',
